...
$app->add(new \Slim\Middleware\JwtAuthentication([
	...
	"path" => [	"/addinvitation", "/invitation/{code}", "/invitations/{status}", "/changeinvitation/{id}", "/displayinvitation/{id}",
				...
				"/registry/{user_id}", "addnewregistry", "/registries/{registry_id}", "/deleteregistry/{registry_id}", "/changeregistrystatus/{registry_id}", "/archive/{registry_id}"
				],
	"header" => "X-Token",
